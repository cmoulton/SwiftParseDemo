...
class LoginViewController: UIViewController {
  ...
  @IBAction func signIn(sender: UIButton) {
    ...
    APIController.sharedInstance.login(self.userField!.text, password: self.passwordField!.text, { (success, error) in
      if error != nil
      {
  ...
  @IBAction func signUp(sender: UIButton) {
    ...
    APIController.sharedInstance.signUp(self.userField!.text, password: self.passwordField!.text, { (success, error) in
      if error != nil
      {
        // TODO: improved error handling
